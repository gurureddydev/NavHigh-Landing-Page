...
We're using modern React (19+) + React Compiler and we're following common best practices focused on
clarity, correctness, and maintainability.
Important to note, some components have incorrect architectural decisions and we'll rework them soon.

## Component Structure & Style

- **PREFER** small, focused components with a single responsibility
- **PREFER** arrow function components over named functions
