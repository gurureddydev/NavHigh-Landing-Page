...
const LoginPage: React.FC = () => {
    return (
        <div className="min-h-screen bg-[#070b13] flex flex-col justify-center items-center px-4 font-sans tracking-[-0.01em] text-slate-200">
            ...
            <Suspense
                fallback={
                    <div className="relative w-full max-w-md bg-slate-950 border border-slate-900 rounded-3xl shadow-[0_32px_64px_rgba(0,0,0,0.5)] overflow-hidden z-10 p-8 flex flex-col items-center justify-center min-h-[350px]">
                        <Loader2 className="w-8 h-8 text-blue-500 animate-spin" />
                        <span className="text-xs text-slate-500 mt-3">Loading portal...</span>
                    </div>
                }
            >
                <LoginForm />
